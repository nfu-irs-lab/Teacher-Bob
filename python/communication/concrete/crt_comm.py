...
if tcp_import:
    ...
    class TCPServerDevice(ReConnectableDevice):
        ...
        def accept(self) -> [str, str, CommDevice]:
            ...
            return address, "Connected", TCPCommDevice(client, self.handler)
...
if bluetooth_import:
    ...
    class BluetoothServerDevice(ReConnectableDevice):
        ...
        def accept(self) -> [str, str, CommDevice]:
            ...
            return client_info, "Connected", BluetoothCommDevice(client_socket, self.handler)
...
if serial_import:
    ...
    class SerialServerDevice(ReConnectableDevice):
        ...
        def accept(self) -> [str, str, CommDevice]:
            return None, "Connected", SerialCommDevice(self.serial, self.handler)
